...
function Integration() {
  return (
    <div className="bg-neutral-900  h-screen">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-20 mt-8 ">
            ...
            <div className="flex flex-col md:flex-row md:block  ">
                <div className="w-full md:w-64 mb-3 float-left sticky to-5 sidebar  ">
                    ...
                    <ul className="list-none space-y-2  hidden md:block">
                        {appName.map((name , ind) =>( <li key={ind} className="border-l-4 ml-3 font-bold py-2 cursor-pointer border-transparent text-gr-600 dark:text-gray-200">{name.text}</li>))}
                    </ul>
                </div>
